...
export const reviewNegativeFeedbacks = [
  "no-show-whatsapp",
  "no-show-event",
  "bad-offline-communication",
  "bad-online-communication",
  "bad-attitude",
  "bad-appearance",
] as const;
type ReviewNegativeFeedback = (typeof reviewNegativeFeedbacks)[number];

export const reviewPositiveFeedbacks = [
  "proactivity",
  "good-offline-communication",
...
export type ExternalVolunteerSchema = InferSchemaType<
  typeof ExternalVolunteerSchema
>;
